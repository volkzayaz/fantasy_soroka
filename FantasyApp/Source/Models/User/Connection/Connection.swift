...
enum Connection {
    ...
    case absent
    case incomming(request: Set<ConnectionRequestType>, draftRoom: Chat.RoomRef)
    case outgoing(request: Set<ConnectionRequestType>, draftRoom: Chat.RoomRef)
